...
def _translate_rules_based(
    ...
    *,
    ...
    if ram_specific_exclude:
        ...
        # When user asks for a standalone GPU card, add stricter system excludes.
        if _card_only:
    ...
    # 5b. RAM exact-GB fallback: if no qualified minimum (e.g. "at least 32GB")
    #     was found but a plain GB value appears in the intent, treat it as a
    #     minimum.  E.g. "Find 32GB DDR4 RAM" → min_capacity_gb = 32.
